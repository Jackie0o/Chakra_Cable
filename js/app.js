(() => {
    ...
    (() => {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            var searchOpen = document.querySelector(".catalog-search__open");
            var searchForm = document.querySelector(".catalog-search__form");
            var searchFormClose = document.querySelector(".catalog-search__form-close");
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            const bodyWrapper = document.querySelector(".header-contacts__body-wrapper");
            headerContacts.addEventListener("click", (function(event) {
                if (event.target.classList.contains("header-contacts__close")) bodyWrapper.classList.remove("_open"); else bodyWrapper.classList.add("_open");
            }));
        }));
        window["FLS"] = true;
        addLoadedClass();
